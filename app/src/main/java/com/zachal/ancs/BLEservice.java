...
import com.zachal.ancs.ANCSGattCallback.StateListener;
...
public class BLEservice extends Service implements ANCSParser.onIOSNotification
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent intentContent = new Intent(getApplicationContext(),MainActivity.class);
        intentContent.setAction(Intent.ACTION_MAIN);
        ...
        Notification notification = new Notification.Builder(getApplicationContext())
                ...
                .setContentText("iPhone Notifier Running")
